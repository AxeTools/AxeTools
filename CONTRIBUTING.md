...
* This project follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer codefix-ci` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  This repository automatically runs tests for pull requests. However,
  running the tests locally will help save time. _Hint: run `composer tests`_.
...
To develop this project, you will need [Docker](https://www.docker.com) and `docker-compose`.  There is a 
definition for a development container that closely mimics the production container used.

There is a Makefile that ships with the solution that can automate the interaction with the development container.  
But you will need to have `make` installed to run the Makefile.

After cloning this repository locally, execute the following commands:

``` bash
cd /path/to/repository
cp devops/axetools-dev/docker-compose.override.yml.example devops/axetools-dev/docker-compose.override.yml
```

You will need to update the `docker-compose.override.yml` file with the location of the repository.

If you can not utilize `make` you can directly bring up the solutions using `make docker-dev-install`
...
coding standards, enforced by [PHP-CS-Fixer](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer).
...
This project uses [ryanwhowe/symfony-template](https://github.com/ryanwhowe/symfony-template) as its
...
sure to `composer install` inside the development container, or run the `make docker-dev-install`.
...
[github]: https://github.com/AxeTools/AxeTools
[issues]: https://github.com/AxeTools/AxeTools/issues
[pull requests]: https://github.com/AxeTools/AxeTools/pulls
